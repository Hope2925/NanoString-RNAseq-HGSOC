...
#SBATCH --output=/scratch/Shares/clauset/Clauset_ABNexus/e_and_o/Adzibolosu_RNAflow.%j.out # Standard output
#SBATCH --error=/scratch/Shares/clauset/Clauset_ABNexus/e_and_o/Adzibolosu_RNAflow.%j.err # Standard error log
...
${NF_EXE} ${SRC}/main.nf -profile slurm --workdir '/scratch/Shares/clauset/Clauset_ABNexus/RNAseq_flow_out/tmp/' --genome_id 'hg38' --outdir '/scratch/Shares/clauset/Clauset_ABNexus/RNAseq_flow_out/Adzibolosu_fw_gg_09.4.24/' --email hope.townsend@colorado.edu --fastqs '/scratch/Shares/clauset/Clauset_ABNexus/raw_data/fastq/Abzibolosu/*.fastq.gz' --forwardStranded
