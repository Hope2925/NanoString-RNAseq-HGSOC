...
#SBATCH --output=/scratch/Shares/clauset/Clauset_ABNexus/e_and_o/RNA_Matched_3.19.25_RNAflow.%j.out # Standard output
#SBATCH --error=/scratch/Shares/clauset/Clauset_ABNexus/e_and_o/RNA_Matched_3.19.25_RNAflow.%j.err # Standard error log
...
${NF_EXE} ${SRC}/main.nf -profile slurm --workdir '/scratch/Shares/clauset/Clauset_ABNexus/RNAseq_flow_out/tmp/' --genome_id 'hg38' --outdir '/scratch/Shares/clauset/Clauset_ABNexus/RNAseq_flow_out/RNA_Matched_4.18/' --email hope.townsend@colorado.edu --fastqs '/scratch/Shares/clauset/Clauset_ABNexus/raw_data/*.fastq.gz' --forwardStranded

## They originally note the 1 as Forward and _3 as Reverse strands for mapping. To match the above, I changed the _3 to _2.
